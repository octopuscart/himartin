            ...
            <article id="tab-1" data-appear-animation="fadeInUp" data-appear-animation-delay="450">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-6 m_xs_bottom_20">
                        <img src="<?php echo base_url(); ?>assets/theme/images/halfcanvas1.jpg" class="r_corners" alt="" style="height: 350px;">
                    </div>
...
<section class="section_offset bg_light_2">
    <div class="container t_align_c">
        ...
        <section class="portfolio_isotope_container home three_columns without_text m_bottom_15" data-isotope-options="{&quot;itemSelector&quot; : &quot;.portfolio_item&quot;,&quot;layoutMode&quot; : &quot;fitRows&quot;,&quot;transitionDuration&quot;:&quot;0.7s&quot;}" style="position: relative; ">
            ...
            <?php
            $customarray = [
                array("title" => "Suit", "id" => "2", "image" => "suitb.jpg", "price" => "1700.00"),
                array("title" => "Shirt", "id" => "2", "image" => "shirts.jpg", "price" => "220.00"),
                array("title" => "Jacket", "id" => "3", "image" => "suita.jpg", "price" => "1200.00"),
                array("title" => "Pant", "id" => "4", "image" => "pant.jpg", "price" => "500.00")
            ];
                        ...
                        <figure class="fp_item t_align_c d_xs_inline_b col-lg-12 col-md-12 col-sm-12" data-appear-animation="bounceIn">
                            ...
                            <figcaption>
                                ...
                                <div class="im_half_container m_bottom_10">
                                    ...
                                    <div class="half_column d_inline_m t_align_r tr_all animate_fctr with_ie">
                                ...
                                <div class="clearfix">
                                    <div class="half_column w_md_full m_md_bottom_10 animate_fctl tr_all f_left f_md_none with_ie">
                                        <a href="#" class="button_type_6 d_inline_b color_light transparent r_corners vc_child tr_all add_to_cart_button"><span class="d_inline_m clerarfix"><i class="icon-basket f_left m_right_10 fs_large"></i><span class="fs_medium">Add to Cart</span></span></a>
                                    </div>
