...
<html class="no-js" lang="en">
    <head>
        ...
        ?>
        <!-- Favicon -->
        <link rel="shortcut icon" href="<?php echo base_url() . 'assets/images/logof_1.png'; ?>" type="image/x-icon">
        <link rel="icon" href="<?php echo base_url() . 'assets/images/logof_1.png'; ?>" type="image/x-icon">

        <link rel="shortcut icon" href="<?php echo base_url() . 'assets/images/logof_1.png'; ?>"/>
        <link rel="apple-touch-icon image_src" href="<?php echo base_url() . 'assets/images/logof_1.png'; ?>"/>
    ...
    $menuitems = [
        ...
        "submenuitems" => [
            ...
            array(
                "title" => "Jackets",
                "link" => site_url('Products/CustomJackets'),),
            array(
                "title" => "Shirts",
                "link" => site_url('Products/CustomShirts'),),
