    ...
    <section class="page_title_1 bg_light_2 t_align_c relative wrapper" style="margin-top: 0px;">
        <div class="container ">
            ...
            switch ($custom_id) {
                case "1":
                    ?>
                               <h4>To view a much wider collection for custom made shirts and feel fabrics, book a fitting now</h4>

                    <?php
                    break;
                case "2":
                    ?>
            <h4>To view a much wider collection for custom made suits and feel fabrics, book a fitting now.</h4>
                    <?php
                    break;
                case "5":
                    ?>
