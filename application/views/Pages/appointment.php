                    ...
                    <div class="col-lg-6 col-md-6 t_align_l fw_light appointment">
                        <form method="post" action="#">
                            <ul class="fw_light">
                                ...
                                <li class="m_bottom_10 m_xs_bottom_15">
                                    <textarea name="remark" placeholder="Remark" class="r_corners w_full"  style="height: 85px;" maxlength="48" ng-model="appointmentSelected.remark" value="{{appointmentSelected.remark}}"  required=""></textarea>
                                </li>
                            </ul>
